            ...
            <div className="col-lg-7 ps-md-5">
              <div className="content-wrapper">
                <div className="title-badge">
                  <h1 className="display-4 fw-bold mb-3 p-3">Why Us?</h1>
                </div>
        ...
        <div className="team-container">
          ...
          <div className="team-member left-align">
            <div className="member-image">
              <img src="/api/placeholder/200/200" alt="Mr. Mahendra Swain" />
            </div>
          ...
          <div className="team-member right-align">
            <div className="member-image">
              <img src="/api/placeholder/200/200" alt="Mr. Ajit Kumar Swain" />
            </div>
            <div className="member-info">
          ...
          <div className="team-member left-align">
            <div className="member-image">
              <img src="/api/placeholder/200/200" alt="Mr. Sunil Kumar Swain" />
            </div>
            <div className="member-info">
