...
//     // Fix: Ensure coupon discount is applied **only once** and does not multiply with cart quantity
...
//             {selectedCoupon && (
//               <p className="d-flex justify-content-between">Coupon Discount <span>₹{appliedDiscount.toFixed(2)}</span></p>
//             )}
