...
const TermsCondition = () => {
  ...
  useEffect(() => {
    // Ensure terms_conditions exists in the config object before setting state
    if (config && config["terms_&_conditions"]) {
      setTerms(config["terms_&_conditions"]);  // Assuming backend gives terms_conditions
    }
  }, [config]);

  console.log("Terms and Conditions Data:", terms);
  return (
    <div className="terms-container container">
      <div className="terms-wrapper">
        ...
        <p className="terms-description">
          ...
          accessing this website, you agree to these terms and conditions in
          full.
        </p>
        ...
        <section className="terms-section">
          ...
          <ul className="section-list">
            ...
            <li>
              All content on this website is for personal, non-commercial use
              only.
            </li>
          </ul>
        </section>
        ...
        <section className="terms-section">
          ...
          <p className="section-paragraph">
            Unless stated otherwise, we or our licensors own the intellectual
            property rights for all material on this website. You may view and
            download content for personal use, but you must not:
          </p>
          <ul className="section-list">
        ...
        <section className="terms-section">
          ...
          <p className="section-paragraph">
            We shall not be held responsible for any damages that arise from the
            use of our website. This includes, but is not limited to, direct,
        ...
        <section className="terms-section">
          ...
          <p className="section-paragraph">
            ...
            website. Please check this page regularly to stay informed.
          </p>
        </section>
